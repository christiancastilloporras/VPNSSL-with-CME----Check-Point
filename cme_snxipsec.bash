...
#### NEW TO MODIFY WITH POLICY NAME, will be dynamic on future
POLICY_PACKAGE_NAME="azureinbound-RB"
#### NEW TO MODIFY WITH VPN DDOMAIN GROUP OBJECT NAME, this need to be hardcoded
GRP_VPNDOM="GRP_cloudcidr"
...
then
		...
		mgmt_cli --session-id $SID set simple-gateway uid $GW_UID vpn-settings.vpn-domain $GRP_VPNDOM vpn-settings.vpn-domain-type manual
